...
import { FaCheckCircle, FaGoogle, FaUser, FaLock, FaEnvelope } from "react-icons/fa";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.status === 200 || res.status === 201) {
        setSuccess(true);
        toast.success(res.status === 200 ? "Bienvenido de nuevo!" : "Bienvenido!", { 
          autoClose: 2000 
        });
      ...
      setError(true);
      toast.error("Error de conexión. Intenta nuevamente.", { autoClose: 5000 });
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="w-full max-w-md mx-auto py-10 px-4">
      ...
      >
        <Card className="shadow-lg border-0 overflow-hidden">
          ...
          <CardHeader className="pb-2 pt-6">
            <h2 className="text-xl font-medium text-center">Credenciales de acceso</h2>
          </CardHeader>
          ...
          <CardContent className="space-y-4 pt-4">
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 border-gray-300 focus:ring-2 focus:ring-blue-500 transition-all ${error ? 'border-red-500' : ''}`}
              />
            </div>
            ...
            <Button
              ...
              disabled={username.length === 0 || password.length === 0 || isLoading || success}
      ...
      <div className="mt-6 text-center text-sm text-gray-500">
        <p>
          ...
          <a href="mailto:redapuntes.info@gmail.com" className="text-blue-600 hover:underline">redapuntes.info@gmail.com</a>
        </p>
      </div>
    </div>
  );
    ...
    <Suspense fallback={
      <div className="flex justify-center items-center w-full h-screen">
        <div className="w-64">
          ...
          <p className="text-center mt-2 text-sm text-gray-500">Cargando...</p>
        </div>
      </div>
    }>
      <LoginPage />
